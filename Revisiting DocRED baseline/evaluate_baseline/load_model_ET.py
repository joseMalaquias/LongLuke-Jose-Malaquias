...
model_path_finetuned = "/mnt/shared/home/jose.luis.malaquias.ext/reDOCRED/baseline_reDOCRED_ET/model_finetuned_baseline_new"
if not os.path.exists(model_path_finetuned):
    os.makedirs(model_path_finetuned)
...
model = ModifiedLuke.from_pretrained(model_path_finetuned)
